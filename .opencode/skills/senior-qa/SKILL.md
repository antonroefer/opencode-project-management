---
name: senior-qa
description: Comprehensive QA and testing skill for quality assurance, test automation, and testing strategies across any programming language or framework. Includes test suite generation, coverage analysis, E2E testing setup, and quality metrics for web, mobile, backend, and desktop applications. Use when designing test strategies, writing test cases, implementing test automation, performing manual testing, or analyzing test coverage.
---
